...
namespace Cake.Storm.Fluent.Internals
{
	public class BuildTaskBuilder : IBuilder
	{
		...
		public void Build()
		{
			...
			CakeTaskBuilder buildTask = _parameters.Context.Task("build");
			CakeTaskBuilder releaseTask = _parameters.Context.Task("release");
			CakeTaskBuilder deployTask = _parameters.Context.Task("deploy");
		...
		{
			CakeTaskBuilder buildTask = _parameters.Context.Task($"build-{taskName}");
			CakeTaskBuilder releaseTask = _parameters.Context.Task($"release-{taskName}");
			CakeTaskBuilder deployTask = _parameters.Context.Task($"deploy-{taskName}");
