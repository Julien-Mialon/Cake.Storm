...
namespace Cake.Storm.Xamarin.Common.Commands
{
    internal abstract class BaseCommand<TSettings> : Tool<TSettings> 
	...
	internal abstract class BaseCommand : BaseCommand<ToolSettings>
	{
